...
#include "src/PlaCloud/application.h"
...
static const char qt_meta_stringdata_Application[] = {
    "Application\0\0openFilesInProgram()\0"
    "setOwnCloudUserName()\0setOwnCloudServer()\0"
    "setOwnCloudPort(QString)\0"
};
...
int Application::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: openFilesInProgram(); break;
        case 1: setOwnCloudUserName(); break;
        case 2: setOwnCloudServer(); break;
        case 3: setOwnCloudPort((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
